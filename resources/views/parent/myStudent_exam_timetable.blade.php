    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-12">
                        <h1>My Student Exam Timetable(Name- <span style="color: rgb(48, 168, 32);">{{ $student->name }} {{ $student->last_name }}</span> , Class- <span style="color: rgb(48, 168, 32);">{{ $getClassName->name }}</span> )</h1>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
        </section>
