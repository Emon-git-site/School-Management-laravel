                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" id="address" class="form-control" name="address" value="{{ old('address', $teacher->address) }}" placeholder="Enter Admission Number" required>
                                <div style="color: red">{{ $errors->first('address') }}</div>
                            </div>
                            <div class="form-group col-md-6">
                                <label for="permanent_address">Permanent Address</label><span style="color:red;">*</span>
                                <input type="text" id="permanent_address" class="form-control" name="permanent_address" value="{{ old('permanent_address', $teacher->permanent_address) }}" placeholder="Enter Roll Number" required>
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="date" id="admission_date" class="form-control" name="admission_date" value="{{ old('admission_date', $teacher->admission_date) }}" placeholder="Enter Admission Date" required>
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" id="work_experience" class="form-control" name="work_experience" value="{{ old('work_experience', $teacher->work_experience) }}" placeholder="Enter Blood Group" required>
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" id="note" class="form-control" name="note" value="{{ old('note', $teacher->note) }}" placeholder="Enter Note" required>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <select name="status" id="status" class="form-control" required>
                                    ...
                                    <option {{ (old('status', $teacher->status) == 0)?'selected':'' }} value="0">Active</option>
                                    <option {{ (old('status', $teacher->status) == 1)?'selected':'' }} value="1">Inactive</option>
                                </select>
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="email" class="form-control" name="email" value="{{ old('email', $teacher->email) }}" placeholder="Enter email" required>
